...
if($rs==0){
	...
	if($berhasil){
		...
		header("location: halamanadmin.php?top=penyakit_solusi.php");
	}else{
		echo "<center><font color='#ff0000'><strong>Penyimpanan Gagal</strong></font></center><br>";
		echo "<center><a href='../admin/halamanadmin.php?top=penyakit_solusi.php'>Kembali</a></center>";
	}	
}else{
...
//$perintah="INSERT INTO penyakit_solusi(kd_penyakit,nama_penyakit,definisi,solusi)VALUES('$kd_penyakit','$nama_penyakit','$definisi','$solusi')";
		...
		//{
			...
			//include "halamanadmin.php?top=penyakit_solusi.php";
