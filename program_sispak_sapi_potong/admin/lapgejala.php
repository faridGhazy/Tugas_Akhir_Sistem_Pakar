...
<head>
	...
	<title>Halaman Relasi Gejala Penyakit</title>
</head>
<body>
	<h2 style="text-align:center;">Informasi Gejala Penyakit</h2><hr>
	<!-- <form name="form1" method="post" action="lapgejala2.php"> -->
	<form name="form1" method="post" action="laporangejala.php">
