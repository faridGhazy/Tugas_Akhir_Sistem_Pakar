  ...
  <div class="CSSTableGenerator">
    <table id="tabel" width="100%" cellpadding="3" cellspacing="0" border="1" align="center">
      <tr valign="top" bgcolor="#CCCC99">
       ...
       <td width="70"><strong>Kode Penyakit </strong></td>
       <td width="70"><strong>Nama Penyakit</strong></td>
       <td width="350"><strong>Definisi</strong></td>
       <td width="350"><strong>Solusi</strong></td>
	...
	//include "../librari/inc.koneksidb.php";
     ...
     while ($data = mysqli_fetch_array ($qry)) {
       ...
       <tr valign="baseline">
        ...
        <td style="text-align: justify;"><?php echo nl2br(htmlspecialchars($data['definisi'])); ?></td> 
        <td style="text-align: justify;"><?php echo nl2br(htmlspecialchars($data['solusi'])); ?></td> 

        <td><a title="Edit Penyakit" href="edit_penyakit.php?kdubah=<?php echo $data['kd_penyakit'];?>"><img src="image/edit.jpeg" width="16" height="16" border="0"></a></td>
