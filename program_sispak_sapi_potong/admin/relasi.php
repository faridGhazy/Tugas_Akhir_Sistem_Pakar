...
//$kdgejala= $_REQUEST['kd_gejala'];
		?>
		<form id="form1" name="form1" method="post" action="simpanrelasi.php" enctype="multipart/form-data"><div>
				...
				<tr bgcolor="#FFFFFF">
					...
					<td><label>
						<select name="TxtKdPenyakit" id="TxtKdPenyakit">
							<option selected="true" disabled="disabled">[ Daftar Penyakit ]</option>
							<?php 
				...
				<tr bgcolor="#FFFFFF">
					...
					<td width="224">
						<select name="TxtKdGejala" id="TxtKdGejala">
							<option selected="true" disabled="disabled">[ Daftar Gejala ]</option>
							<?php 
	...
	<table width="100%" border="0" cellpadding="4" cellspacing="1" bordercolor="#F0F0F0" >
		<tr>
			<td width="32" style="text-align: center;"><strong>No</strong></td>
			<td width="105" style="text-align: center;"><strong>Gejala</strong></td>
			<td width="535" style="text-align: center;"><strong>Nama Penyakit</strong><span style="float:right; margin-right:25px;"><strong></strong></span></td>
		</tr>
		<?php
	...
	//$query2=mysql_query("SELECT relasi.kd_gejala FROM relasi WHERE relasi.kd_penyakit='$idpenyakit'")or die(mysql_error());
				...
				while ($row2=mysqli_fetch_array($query2)){
					...
					echo "<td width='30' style='text-align: center;'>$row2[kd_gejala]</td>";
					echo "<td width='300'>$row2[namagejala]</td>";
					echo "<td width='20' style='text-align: center;'>$row2[bobot]</td>";
					echo "<td width='20' style='text-align: center;'><a title='Edit Relasi' href='halamanadmin.php?top=edit_relasi.php&id_relasi=$row2[id_relasi]'>Edit</a></td>";
					echo "<td width='20' style='text-align: center;'><a title='Hapus Relasi' style='cursor:pointer;' onclick='return konfirmasi($row2[id_relasi])'>Hapus</a></td>";
					echo "</tr>";
					echo "</table>";
				}
			?>      <br /></td>
